...
function startGame() {
  ...
  myGamePiece = new component(30, 30, "#0f0", 10, 120);

  // Setting the gravity of the component
  myGamePiece.gravity = 0.05;

  // Creating the score design
  myScore = new component("15px", "'Press Start 2P'", "#fff", 280, 40, "text");
...
function updateGameArea() {
  ...
  if (myGameArea.frameNo == 1 || everyinterval(150)) {
    ...
    myObstacles.push(new component(10, height, "#f0f", x, 0));

    // Creating obstables under the main component
    myObstacles.push(
      new component(10, x - height - gap, "#f0f", x, height + gap)
    );
  }
